...
<head>
    ...
    <title>Sistem Informasi Kursus & Absensi - Murid</title>
...
<div class="canvas-container">
    ...
    <div class="sidebar">
        ...
        <ul class="menu">
            <li><a href="#"><span class="material-symbols-outlined">home</span> Dashboard</a></li>
    ...
    <div class="main-content">
        ...
        <div class="header-section">
            <div class="title-area">
                <h1>Murid</h1>
                <div class="breadcrumb">Beranda / <span>Murid</span></div>
            </div>
            <div class="action-area">
                ...
                <div class="search-container">
                    ...
                    <input type="text" class="search-input" placeholder="Cari murid..." id="searchInput">
                </div>
            </div>
        </div>
                            ...
                            <td>
                                <div class="action-buttons">
                                    ...
                                    <a href="kontrolmurid.php?aksi=hapus&id=<?= $row['id_murid']; ?>"
                                       ...
                                       title="Hapus"
                                       onclick="return confirm('Yakin ingin menghapus data <?= htmlspecialchars($row['nama_murid'], ENT_QUOTES); ?>?');">
